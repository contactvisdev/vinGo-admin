...
const PharmacyView = () => {
  ...
  return (
    <div style={{ background: '#f8f9fb', minHeight: '100vh', padding: 20 }}>
      <MainCard>
        <TopTitleCard title="Pharmacy Review" breadcrumbs={breadcrumbs} />
      ...
      <Modal show={showRejectModal} onHide={() => setShowRejectModal(false)} centered>
        <Modal.Header closeButton>
          <Modal.Title>Reject Grocery</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Form.Control
            as="textarea"
