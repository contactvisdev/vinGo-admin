...
export const COUNTRY_OPTIONS = RAW_COUNTRIES.map((c) => ({
  name: c.name,
  value: c.name
}));

/** Map country name → ISO alpha-2 code (e.g. "India" → "IN") */
export const COUNTRY_NAME_TO_CODE = Object.fromEntries(RAW_COUNTRIES.map((c) => [c.name, c['alpha-2']]));
