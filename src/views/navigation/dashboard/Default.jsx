...
import { UsersMap, EarningChart, RatingCard, RecentUsersCard } from 'components/dashboard/default';
  ...
  return (
    <Row>
      ...
      {salesPerformanceData.map((item, index) => (
        <Col key={item.title} md={index === 2 ? 12 : 6} xl={4}>
      ...
      {socialStatsData.map((item, index) => (
        <Col key={item.icon} md={index === 0 ? 12 : 6} xl={4}>
