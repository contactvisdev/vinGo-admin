...
const LiquorView = () => {
  ...
  const handleRejectSubmit = async () => {
    ...
    try {
      ...
      navigate('/merchant-management/liquors', { replace: true });
    } catch (err) {
  ...
  return (
    <div style={{ background: '#f8f9fb', minHeight: '100vh', padding: 20 }}>
      <MainCard>
        <TopTitleCard title="Liquor Review" breadcrumbs={breadcrumbs} />
      ...
      <Modal show={showRejectModal} onHide={() => setShowRejectModal(false)} centered>
        <Modal.Header closeButton>
          <Modal.Title>Reject Liquor</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Form.Control
            as="textarea"
