import { useGroceryTable, useGroceryDelete } from './Container';
    ...
    return (
      <div className="d-flex gap-2">
        <button
          ...
          onClick={() => navigate(`/merchant-management/groceries/view/${rowData._id}?tab=${activeTab}`)}
          title="view"
          disabled={loading}
        >
          <Eye size={16} />
        ...
        <button
          type="button"
          className="btn btn-outline-primary btn-sm rounded-circle d-flex align-items-center justify-content-center"
          onClick={() => navigate(`/merchant-management/groceries/edit/${rowData._id}?tab=${activeTab}`)}
          title="Edit"
          disabled={loading}
        >
          <Pencil size={16} />
  ...
  return (
    <div className="container-fluid">
      ...
      <TabSection
        ...
        loading={loading}
        addButtonText="+ Add New Grocery"
        onAddClick={() => navigate('/merchant-management/groceries/add')}
        additionalButtons={
